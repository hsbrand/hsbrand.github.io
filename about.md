...
<section class="values section-pad section-rule"><div><span>01</span><h2>Hockey first</h2><p>Everything begins with the language, rituals, and personality of the game.</p></div><div><span>02</span><h2>Made together</h2><p>The project is rooted in curiosity, collaboration, and learning by doing.</p></div><div><span>03</span><h2>Never generic</h2><p>We want every design to feel intentional—not like another piece of ordinary team merchandise.</p></div></section>
